...
from zividsamples.gui.widgets.pose_widget import MarkerPosesWidget, PoseWidget, PoseWidgetDisplayMode
...
from zividsamples.gui.wizard.marker_configuration import generate_marker_dictionary
...
from zividsamples.gui.wizard.touch_configuration import TouchConfigurationWidget
from zividsamples.transformation_matrix import TransformationMatrix


class TouchGUI(TabWidgetWithRobotSupport):
    marker_confirmed: bool
    marker_captured: bool
    ...
    def setup_layout(self):
        ...
        right_panel.addWidget(self.touch_configuration_widget)
    ...
    def process_capture(self, frame: zivid.Frame, rgba: NDArray[Shape["N, M, 4"], UInt8], settings: SettingsPixelMappingIntrinsics):  # type: ignore
        ...
        detection_result = zivid.calibration.detect_markers(
            frame,
            [touch_configuration.marker_id],
            touch_configuration.marker_dictionary,
        )
    ...
    def get_tab_widgets_in_order(self) -> List[QWidget]:
        ...
        widgets.extend(self.touch_configuration_widget.get_tab_widgets_in_order())
