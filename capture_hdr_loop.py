...
def _main():
    ...
    exposure_time_frame_1 = [datetime.timedelta(microseconds=10000), datetime.timedelta(microseconds=90000) , datetime.timedelta(microseconds=40000)]
    exposure_time_frame_2 = [datetime.timedelta(microseconds=40000), datetime.timedelta(microseconds=10000) , datetime.timedelta(microseconds=90000)]
    exposure_time_frame_3 = [datetime.timedelta(microseconds=90000), datetime.timedelta(microseconds=40000) , datetime.timedelta(microseconds=10000)]
